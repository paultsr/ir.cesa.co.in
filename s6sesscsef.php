<html>
<head>
<title>IR Sessional Marks (RAW)</title>
...
$qu="SELECT * from s8cse where urno='". $ureg2 ."'";
$res=mysql_query($qu);
...
echo "<center><b><u>CSE 2009 - 2013 Batch - IR Sessional Marks (RAW)</u></b></center>";
...
{
echo "<center><b>Work Hard !</b></center>";
}
echo "<br>";
